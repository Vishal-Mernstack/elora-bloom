...
const appCss = "/assets/styles-BFoH4kb-.css";
...
const Route$1 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Elora's PMU & Korean Esthetics — Lip Blushing Delhi" },
      { name: "description", content: "Premium lip blushing and Korean PMU services in Delhi. Book a free consultation today." },
      { name: "author", content: "Elora's PMU & Korean Esthetics" }
    ],
    links: [
      {
        rel: "stylesheet",
...
const $$splitComponentImporter = () => import("./index-1JTWiP7n.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Premium lip blushing in Delhi by Elora — Korean PMU certified. Natural, long-lasting lip tint. ₹12,000 onwards. Book your free consultation today."
    }, {
      property: "og:title",
      content: "Lip Blushing in Delhi | Elora's PMU & Korean Esthetics"
    }, {
      property: "og:description",
      content: "Wake up with perfectly tinted lips — no lipstick needed. Korean-grade pigments, 200+ happy clients in Delhi. Book a free consultation."
    }, {
      property: "og:type",
      content: "website"
    }, {
    ...
    scripts: [{
      ...
      children: JSON.stringify({
        ...
        mainEntity: [{
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Results last 2–3 years. Delhi's humidity doesn't significantly affect longevity when proper aftercare is followed."
          }
        }, {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "No. We apply medical-grade topical numbing cream for 30 minutes before the procedure, making it virtually painless for most clients."
          }
        }, {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Lip blushing uses semi-permanent pigment in soft, sheer layers for a natural blush effect. Traditional lip tattoos use permanent ink with harsh, saturated results."
          }
        }, {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Our packages start at ₹12,000 for a single Blush Nude session. Free consultations included."
          }
        }, {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "7–14 days. Lips will appear darker for the first week then peel to reveal the true healed color."
          }
        }]
      })
    }]
